...
export enum API {
	...
	VERSION = "v1",
	FORM = "form",
	S3 = "https://moacube.s3.ap-northeast-2.amazonaws.com/",
	BUCKET = "moacube",
	REGION = "ap-northeast-2",
	S3_ACCESS_KEY = "AKIA3QDC75LMFZXELN43",
	S3_SECRET_ACCESS_KEY = "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",
	// LOGIN = "/user/login",
	// LOGOUT = "/user/logout",
	// CHECKLOGIN = "/user/islogin",
	// FILTER = "/recruit/filter/",
